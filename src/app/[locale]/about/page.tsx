...
const BODY = {
  ...
  ru: [
    'Nurly Tolkun обеспечивает морскую поддержку офшорного строительства и нефтегазовых операций — от фрахта судов и морского агентирования до подводно-технических работ, обслуживания спасательного оборудования и сертификации грузоподъёмных устройств.',
